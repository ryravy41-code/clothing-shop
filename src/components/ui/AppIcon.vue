...
const ICONS: Record<string, IconDef> = {
  ...
  'qr-code': {
    inner:
      '<path d="M12 2C6.48 2 2 6.48 2 12s4.48 10 10 10 10-4.48 10-12S6.48 2 2 2zm5.5 13c-.83 0-1.5-.67-1.5-1.5s.67-1.5 1.5-1.5 1.5.67 1.5 1.5-.67 1.5-1.5 1.5zM12 5.5a4.5 4.5 0 1 0 0 9 4.5 4.5 0 0 0 0-9z"/>',
  },
  quote: {
    inner:
